...
public class FastTrig {
	...
	/*
	 * Accurate to 6.82e-8, 3.3x faster than Math.sin.
	...
	/*
	 * Accurate to 5.6e-7, 4x faster than Math.cos.
	...
	/*
	 * Accurate to 6.82e-8, better than 3.3x faster than Math.sin.
	 * Faster than lookup table in real-world conditions due to less cache misses.
	 * All values from "Fast Polynomial Approximations to Sine and Cosine", Garret, C. K., 2012
	 */
	...
	/*
	 * Accurate to 5.6e-7, better than 4x faster than Math.cos.
	 * Faster than lookup table in real-world conditions due to less cache misses.
	 * All values from "Fast Polynomial Approximations to Sine and Cosine", Garret, C. K., 2012
	 */
